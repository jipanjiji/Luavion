...
-- util.lua
--
-- This Script provides some utility functions for ZeroLua.
...
local function escape(str)
	-- Convert UTF-8 Zero-Width characters (U+200B, U+200C, U+200D) to Luau Unicode escapes
	str = str:gsub("\226\128\139", "\\u{200B}")
	str = str:gsub("\226\128\140", "\\u{200C}")
	str = str:gsub("\226\128\141", "\\u{200D}")
